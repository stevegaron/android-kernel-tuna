...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 525000000, OMAP4460_VDD_MPU_OPP75_UV),
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 700000000, OMAP4460_VDD_MPU_OPP100_UV),
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 810000000, OMAP4460_VDD_MPU_OPP125_UV),
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 920000000, OMAP4460_VDD_MPU_OPPTURBO_UV),
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1060000000, OMAP4460_VDD_MPU_OPPTURBOPLUS_UV),
	/* MPU OPP4 - OPP-Nitro */
